...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = (
  "𝐇𝐞𝐲𝐲 𝐭𝐡𝐞𝐫𝐞! 𝐈 𝐚𝐦 𝐌𝐫𝐢𝐠𝐧𝐚𝐲𝐚𝐧𝐢'𝐬 𝐮𝐬𝐞𝐫𝐛𝐨𝐭.\𝐧\𝐧"
  "𝐃𝐨𝐧'𝐭 𝐡𝐞𝐬𝐢𝐭𝐚𝐭𝐞. 𝐓𝐡𝐢𝐬 𝐢𝐬 𝐚𝐧 𝐚𝐮𝐭𝐨𝐦𝐚𝐭𝐞𝐝 𝐦𝐞𝐬𝐚𝐚𝐠𝐞.\𝐧\𝐧"
  "𝐌𝐲 𝐦𝐚𝐬𝐭𝐞𝐫 𝐡𝐚𝐯𝐞𝐧'𝐭 𝐚𝐩𝐩𝐫𝐨𝐯𝐞𝐝 𝐲𝐨𝐮 𝐭𝐨 𝐏𝐌 𝐲𝐞𝐭.\𝐧\𝐧"
  "𝐏𝐥𝐞𝐚𝐬𝐞 𝐰𝐚𝐢𝐭 𝐟𝐨𝐫 𝐦𝐲 𝐦𝐚𝐬𝐭𝐞𝐫 𝐭𝐨 𝐥𝐨𝐨𝐤 𝐢𝐧, 𝐬𝐡𝐞 𝐦𝐨𝐬𝐭𝐥𝐲 𝐚𝐩𝐩𝐫𝐨𝐯𝐞 𝐏𝐌𝐬 𝐮𝐧𝐥𝐞𝐬𝐬 𝐲𝐨𝐮 𝐚𝐫𝐞 𝐫𝐞𝐭𝐚𝐫𝐝𝐞𝐝.\𝐧\𝐧"
  "𝐔𝐧𝐭𝐢𝐥 𝐭𝐡𝐞𝐧, 𝐩𝐥𝐞𝐚𝐬𝐞 𝐝𝐨𝐧'𝐭 𝐬𝐩𝐚𝐦 𝐡𝐞𝐫 𝐏𝐌. 𝐒𝐩𝐚𝐦𝐦𝐢𝐧𝐠 𝐲𝐨𝐮'𝐥𝐥 𝐚𝐮𝐭𝐨𝐦𝐚𝐭𝐢𝐜𝐚𝐥𝐥𝐲 𝐠𝐞𝐭 𝐛𝐥𝐨𝐜𝐤𝐞𝐝 & 𝐫𝐞𝐩𝐨𝐫𝐭𝐞𝐝!! \𝐧\𝐧"
